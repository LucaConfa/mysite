...
function PopUpInstruction(){
  ...
  swal({
    title:"Calibration",
    text: "Please click on each of the 9 points on the screen. You must click on each point "+clicks+" time(s) till it goes yellow. This will calibrate your eye movements.",
    buttons:{
      cancel: false,
      confirm: true
    }
...
$(document).ready(function(){
  ...
  helpModalShow();
     $(".Calibration").click(function(){ // click event on the calibration buttons
      ...
      if (CalibrationPoints[id] == calibrationClicks){ //only turn to yellow after 5 clicks
                ...
                $(document).ready(function(){
                  ...
                  sleep(5000).then(() => {
                      ...
                      swal({
                        ...
                        " Your MAE with '"+gazeLimit+"' gaze points is " + mae.toFixed(2) + "px",
                        icon: 'info',
                        allowOutsideClick: false,
                        buttons: {
                          cancel: "Recalibrate",
    ...
    function() {
      ...
      if (i > 1) {
        ...
        if (targetToProcessId <= TOTAL_MAE_TARGETS) {
          ...
          var targetCoordinates = getCenterCoordinates($(targetToProcessSelector));
          var mae = calculateMae(past50, gazeLimit, targetCoordinates);
